...
infer: build
	@echo "=== Acionando o MCP Server para Validação ==="; \
	 echo '{"jsonrpc":"2.0","method":"tools/call","id":1,"params":{"name":"analyze_distributed_liquidation","arguments":{"cpf":"12345678900","amount":"450.50","date":"2026-05-10"}}}' | ./bin/mcp-server | jq -r '.result.content[0].text' | jq .
